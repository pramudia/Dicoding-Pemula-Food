...
<form name="in_matkul" action="/ms/V_Dosen.php" method="POST">
Cari Berdasarkan Nama atau Kode : <input type="text" name="nama" maxlength="30" /></button>
                   <input type="submit" value="Cari" />
  
</p>
<div class="bg-color-yellow fg-color-white padding20">
  <h3 class="fg-color-white">Data Guru.</h3>
                    </div>
                   <table width="1207" height="98" class="table">
                    <tbody>
                     </tbody>
                    <thead>
                      <tr class="info">
                        <th width="68">No</th>
                        <th width="429" class="right">Kode Guru</th>
                        <th width="308" class="right">Nama Guru</th>
                        <th width="213" class="right">Telepon</th>
                        <th width="165" class="right">Email</th>
                      </tr>
                    </thead>
                    <tbody>
 ...
 <?php  $nama=$_POST['nama'];	
    $query = mysql_query ("SELECT * FROM dosen WHERE nm_dosen LIKE '%$nama%' or kd_dosen like '%$nama%'");
    $no  = 1;
...
?>
                      <tr bgcolor="#B91D47" class="bg-color-yellow">
