...
?>
          ...
          <div class="bg-color-green fg-color-white padding20">
                        <h3 align="center" class="fg-color-white">Jadwal Kuliah Teknik Informatika.</h3>
          </div>
...
<?php $thn_ajaran= $_POST['thnajaran']; ?>
 <form name="in_matkul" action="/ms/jadwalbesar.php" method="POST">
 <div align="center">
   <p align="left">TAHUN AJARAN:
     <select name ="thnajaran">
...
?>
         ...
         <tr >
           ...
           <td rowspan="3" bordercolorlight="#FF0000"><strong>snn</strong></td>
...
?>
         ...
         <tr >
           <td rowspan="3"><strong>sls</strong></td>
...
?>
       ...
       <tr >
         <td rowspan="2" bgcolor="#00FF66"><strong>snn</strong></td>
         <td bgcolor="#00FF66"><strong> 1 </strong></td>
         <?php
...
?>
       ...
       <tr >
         <td bgcolor="#00FF66"><strong> 2 </strong></td>
         <?php
  //jam kedua
	$query1 = mysql_query ("SELECT jadwal.kd_matkul, matkul.semester, jadwal.kelas, jadwal.kd_dosen, jadwal.kd_ruang FROM jadwal LEFT JOIN matkul 
